...
public final class Constants {
  ...
  public static final class CommunityConstants {
    ...
    public static final double kLongDistance = 3.8 + 0.25;
  ...
  public static final class ChargeStationConstans {
    public static final double kApproachSpeed = 0.21;
  ...
  public static final class PassChargeStationConstants {
    public static final double kUpSpeed = 0.25; //  0.2
    public static final double kDownSpeed = 0.2; // 0.15
