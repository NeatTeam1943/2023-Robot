...
public class AutoFunctions {
     ...
     *
     * Requirements: Placing the robot right on the line facing the grids
     */
    public Command passLine() {
        return new DriveDistance(m_drive, ExitCommConstants.kLineDistance, true);
    }

    /**
     * Exit community from grids on the short side
     *
     * Requirements: Placing the robot next to the grids and opposing alliance
     * loading zone facing the grids
     */
    public Command passShort() {
        return new DriveDistance(m_drive, ExitCommConstants.kShortDistance, true);
    }

    /**
     * Exit community from grids on the long side
     *
     * Requirements: Placing the robot next to the grids facing the grids
     */
    public Command passLong() {
        return new DriveDistance(m_drive, ExitCommConstants.kLongDistance, true);
    }

    /**
     * Exit the comunity through the charge station
     *
     * Requirements: Placing the robot in front of the charge station facing the
     * grids
     */
    public Command passChargeStation() {
        return new DriveToCommunity(m_drive, true);
    }
    ...
    public Command stabilize(boolean backwards) {
        Command driveAndClose = Commands.parallel(
    ...
    /**
     * Exit the community through the charge station and then drive back to the
     * charge station and stabilize
     *
     * Requirements: Placing the robot in front of the charge station facing the
     * grids
     */
     ...
     *
     * Requirements: Place the robot close the grids in front of the charge station
     * facing the grids
     */
     ...
     *
     * Requirements: Placing the robot close to the grids and opposing allience
     * loading zone facing the grids
     */
    public Command gamePieceAndPassShort() {
        Command closeAndPassShort = Commands.parallel(
                new CloseDoor(m_door),
                passShort());
     ...
     *
     * Requirements: Place the robot close to the grids and the barier facing the
     * grids
     */
    public Command gamePieceAndPassLong() {
        Command closeAndPassLong = Commands.parallel(
                new CloseDoor(m_door),
                passLong());
    ...
    /**
     * Score one game piece, leave the commuity trough the charge station, go
     * back to charge station and stabilize
     *
     * Requirements: Place the robot close the grids in front of the charge station
     * facing the grids
     */
    public Command fullRoute() {
        Command closeAndPassChargeStation = Commands.parallel(
                new CloseDoor(m_door),
                passChargeStation());

        return Commands.sequence(
                new OpenDoor(m_door),
                closeAndPassChargeStation,
                stabilize(false));
    }
}
